...
public class OurServletContext implements ServletContextListener {
    ...
    private void setPaymentCredential(ServletContext serCtx) {
        ...
        for (Long merchant : merchants) {
            Map<Long, PaymentCredential> payCredentials;
            try {
                payCredentials = getPayCredentials(merchant);
     ...
     */
    private Map<Long, PaymentCredential> getPayCredentials(Long merchant) throws MalformedURLException {
        ...
        String defaultCancelUrl = "http://localhost:8080/onepay_bankpayment/callback/23/merchant/1234";
        String defaultReturnUrl = "http://localhost:8080/onepay_bankpayment/callback/23/merchant/1234";
